...
var RETRYABLE = false;
var MultiMapTryLockCodec = (function () {
    function MultiMapTryLockCodec() {
    }
    MultiMapTryLockCodec.calculateSize = function (name, key, threadId, lease, timeout) {
        var dataSize = 0;
    ...
    MultiMapTryLockCodec.encodeRequest = function (name, key, threadId, lease, timeout) {
