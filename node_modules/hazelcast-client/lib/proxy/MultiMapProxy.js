...
var MultiMapProxy = (function (_super) {
    ...
    MultiMapProxy.prototype.addEntryListener = function (listener, key, includeValue) {
        ...
        if (key) {
            var keyData = this.toData(key);
            request = MultiMapAddEntryListenerToKeyCodec_1.MultiMapAddEntryListenerToKeyCodec.encodeRequest(this.name, keyData, includeValue, false);
            ...
            return this.client.getListenerService().registerListener(request, handler, MultiMapAddEntryListenerToKeyCodec_1.MultiMapAddEntryListenerToKeyCodec.decodeResponse, keyData);
        }
        else {
            request = MultiMapAddEntryListenerCodec_1.MultiMapAddEntryListenerCodec.encodeRequest(this.name, includeValue, false);
            var handler = function (m) {
                MultiMapAddEntryListenerCodec_1.MultiMapAddEntryListenerCodec.handle(m, entryEventHandler, toObject);
            };
            return this.client.getListenerService().registerListener(request, handler, MultiMapAddEntryListenerCodec_1.MultiMapAddEntryListenerCodec.decodeResponse);
        }
    };
    MultiMapProxy.prototype.removeEntryListener = function (listenerId) {
        return this.client.getListenerService().deregisterListener(MultiMapRemoveEntryListenerCodec_1.MultiMapRemoveEntryListenerCodec.encodeRequest(this.name, listenerId), MultiMapRemoveEntryListenerCodec_1.MultiMapRemoveEntryListenerCodec.decodeResponse);
    };
    MultiMapProxy.prototype.lock = function (key, leaseMillis) {
        if (leaseMillis === void 0) { leaseMillis = -1; }
        var keyData = this.toData(key);
        return this.encodeInvokeOnKey(MultiMapLockCodec_1.MultiMapLockCodec, keyData, keyData, 1, leaseMillis);
    };
    ...
    MultiMapProxy.prototype.tryLock = function (key, timeoutMillis, leaseMillis) {
        ...
        if (leaseMillis === void 0) { leaseMillis = -1; }
        var keyData = this.toData(key);
        return this.encodeInvokeOnKey(MultiMapTryLockCodec_1.MultiMapTryLockCodec, keyData, keyData, 1, leaseMillis, timeoutMillis);
    };
    MultiMapProxy.prototype.unlock = function (key) {
        var keyData = this.toData(key);
        return this.encodeInvokeOnKey(MultiMapUnlockCodec_1.MultiMapUnlockCodec, keyData, keyData, 1);
    };
    MultiMapProxy.prototype.forceUnlock = function (key) {
        var keyData = this.toData(key);
        return this.encodeInvokeOnKey(MultiMapForceUnlockCodec_1.MultiMapForceUnlockCodec, keyData, keyData, 1);
    };
