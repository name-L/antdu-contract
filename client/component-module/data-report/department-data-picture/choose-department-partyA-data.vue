...
export default {
    ...
    methods: {
        ...
        partyAChearts (partyAData) {
            // echarts.init(document.getElementById('partyA')).dispose();
            var chartDom = document.getElementById('partyA');
                        ...
                        myCsv: {
                            ...
                            onclick: (params) => {
                                this.getExportStatisticsData({
                                    type: this.partyADepartment.includes('地域') ? 'region' : 'department',
                                    _this: this,
                                    name: this.partyADepartment,
                                    item: 'party_a',
                                    typeParam: this.name
                                });
                            }
...
<style lang="less" scoped src="./choose-department-partyA-data.less">
